export default function Oreon() {
  return (
    <div className="theme-light pt-[56px] min-h-screen bg-white flex items-center justify-center">
      <section className="enterprise-section text-center max-w-2xl px-4">
