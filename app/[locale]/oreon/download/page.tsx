  ...
  const editions: Edition[] = [
    {
      ...
      image: '/oreon10.png',
      architectures: [
        { label: 'x86_64', noteKey: 'download.intelAmd' as const, hash: 'd3c586be9b5d832bd3e6cb1f3c4ca4ab96a500889492204c0e8e4ab4cd108395', link: 'https://mirrors.oreonhq.com/Oreon-10-2607-x86_64.iso' },
