  ...
  const editions = [
    {
      ...
      image: '/oreon10.png',
      architectures: [
        { label: 'x86_64', noteKey: 'download.intelAmd' as const, hash: '01024aa0732655c91fcbf2daa19ae23689adc0b114645a4a866c81048cf91af8', link: 'https://mirrors.oreonhq.com/Oreon-10-2603.4-x86_64.iso' },
